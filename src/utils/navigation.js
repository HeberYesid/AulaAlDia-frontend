...
const NAVIGATION_ITEMS = [
  ...
  
  {
    ...
    to: '/schedules',
    label: 'Horarios',
    contextualTip: 'Consulta los horarios por rol en formato semanal o diario según tu perfil institucional.',
    icon: CalendarClock,
    section: 'academic',
    roles: [USER_ROLES.ADMIN, USER_ROLES.TEACHER, USER_ROLES.STUDENT, USER_ROLES.TUTOR],
...

  {
    ...
    contextualTip: 'Consultá tus registros diarios de entrada y salida para validar tu trazabilidad de asistencia.',
    icon: History,
    section: 'academic',
